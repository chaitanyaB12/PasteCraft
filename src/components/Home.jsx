...
const Home = () => {
  ...
  useEffect(() => {
    if (pasteId) {
      ...
      // Reset the form if there's no pasteId in the URL (new paste)
      setTitle("");
      setValue("");
    }
  }, [pasteId, pastes]);
    ...
    <div className="w-full h-full py-10 max-w-[1200px] mx-auto px-5 lg:px-0">
      <div className="flex flex-col gap-y-5 items-start">
        <div className="w-full flex flex-row gap-x-4 justify-between items-center">
          ...
          />
          <button
            className="text-white bg-blue-900 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700"
            onClick={createPaste} >
